...
export type BlendProductsQueryVariables = StorefrontAPI.Exact<{
  first: StorefrontAPI.Scalars['Int']['input'];
}>;


export type BlendProductsQuery = { products: { nodes: Array<(
      Pick<StorefrontAPI.Product, 'id' | 'title'>
      & { metafields: Array<StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>>, variants: { nodes: Array<Pick<StorefrontAPI.ProductVariant, 'id' | 'availableForSale' | 'quantityAvailable'>> } }
    )> } };
...
export type ProductFragment = (
  ...
  & { tastingNotes?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>, brewingSuggestion?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>, options: Array<(
